    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath, false, Encoding.UTF8))
            {
                ...
                sw.WriteLine("Requires port forwarding. The web panel requires an open port to function.");
                sw.WriteLine("Set the port you wish the panel to utilize. If this port is unavailable, it will attempt to use one a few higher than the control panel port. It will be reported in the output log");
                ...
                sw.WriteLine("If the zone is set to PvE, it applies to both the killer and victim. If either one are protected, it will be detected.");
                ...
                sw.WriteLine("If a player is killed in a PvE zone by a player, the victim receives a message upon respawn alerting them to type /return. This command brings them back to their death spot.");
                ...
                sw.WriteLine("Setting the zone as PvE will punish players for attempting to kill others standing inside the zone or while they are in one.");
