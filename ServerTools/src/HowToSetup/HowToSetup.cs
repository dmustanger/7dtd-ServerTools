    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath, false, Encoding.UTF8))
            {
                ...
                sw.WriteLine("This was drafted for version 19.6.4");
                sw.WriteLine();
                ...
                sw.WriteLine("Players type /way to list existing. /way 'name' to use that waypoint. /waysave 'name' to save where they are standing with that name. /waydel 'name' to remove the existing point. They can also use /setway 'name' as an alternative.");
