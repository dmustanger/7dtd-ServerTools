    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath, false, Encoding.UTF8))
            {
                ...
                sw.WriteLine("<Tool Name=\"Auction_Extended\" Panel=\"False\" Panel_Name=\"Awesome Auction\" Link=\"http://0.0.0.0:8084/auction.html\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Set your desired web address to locate the Auction");
                sw.WriteLine();
                ...
                sw.WriteLine("The link controls the web address players will be sent to when they open the panel. This is your server IP, servertools Web_API port and include auction.html.");
                sw.WriteLine("Changing the link will automatically update your xpath documents required for UI changes but requires a server restart to take full effect.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Auto_Backup\" />");
                sw.WriteLine("<Tool Name=\"Auto_Backup\" Enable=\"False\" Delay_Between_Saves=\"240\" Destination=\"\" Compression_Level=\"0\" Backup_Count=\"5\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("<Tool Name=\"Died\" Enable=\"False\" Time=\"2\" Delay_Between_Uses=\"120\" Command_Cost=\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine("After a player dies, they have to type /died within the Time limit you have set to be brought back to their death position.");
                ...
                sw.WriteLine("<Tool Name=\"Discord_Link\" Enable=\"False\" Invitation_Link=\"http://discord.gg/linkHere\" />");
                sw.WriteLine();
                sw.WriteLine("Lets players type /discord to show a new window they can click on that opens the steam web browser to the link provided.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine("<Tool Name=\"Kill_Notice\" Enable=\"False\" PvP=\"False\" Zombie_Kills=\"True\" Animal_Kills=\"True\" Show_Level=\"False\" />");
                sw.WriteLine("<Tool Name=\"Kill_Notice_Extended\" Show_Damage=\"False\" Misc=\"True\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine("If a player kills another player or zombie kills a player, a chat notice will show it.");
                sw.WriteLine("PvP controls whether it shows players killing a player.");
                sw.WriteLine("Zombie_Kills controls whether it shows zombies killing a player.");
                sw.WriteLine("Animal_Kills controls whether it shows zombies killing a player.");
                sw.WriteLine("Show_Level controls if the player level is shown in the notice.");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Show_Damage");
                sw.WriteLine("Set True or False for Misc");
                sw.WriteLine();
                sw.WriteLine("Show_Damage controls if the final damage that killed them is shown in the notice.");
                sw.WriteLine("Misc will show deaths by falling, concussion, disease and others.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine("<Tool Name=\"Shop\" Enable=\"True\" Inside_Market=\"False\" Inside_Traders=\"False\" Panel=\"True\" Link=\"http://0.0.0.0:8084/shop.html\" />");
                sw.WriteLine("<Tool Name=\"Shop_Extended\" Panel_Name=\"OC's Shop\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Inside_Market");
                sw.WriteLine("Set True or False for Inside_Traders");
                sw.WriteLine("Set True or False for Panel");
                sw.WriteLine("Set a web address for Link");
                sw.WriteLine();
                ...
                sw.WriteLine("Typing /shop in chat will open a window with a clickable link while the panel is active. The link is directed towards the interactive shop panel");
                sw.WriteLine();
                ...
                sw.WriteLine("<Tool Name=\"Vehicle_Recall_Extended\" Normal_Max=\"2\" Reserved_Max=\"4\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Inside_Claim");
                ...
                sw.WriteLine("Command cost controls how much must be in a player's wallet to use the command.");
                sw.WriteLine();
                sw.WriteLine("Set a numeric value for Normal_Max");
                sw.WriteLine("Set a numeric value for Reserved_Max");
                sw.WriteLine();
                sw.WriteLine("Normal_Max controls how many vehicles each normal player can save.");
                sw.WriteLine("Reserved_Max controls how many vehicles each reserved player can save.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine("Players can place two blocks down to mark the corners of a wall. It will automatically check near by secure chests for matching blocks to fill the space between them.");
                sw.WriteLine("This will only work inside of their own claimed space, not an allies.");
                sw.WriteLine("Player_Check will look for players near by and prevent use of the command.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine("<Tool Name=\"Web_API\" Enable=\"True\" Port=\"8084\" Icon_Folder=\"C:/7DaysToDieServers/DedicatedStable/Data/ItemIcons\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Shop and Auction panel both use the in game icons provided by the server. Provide the folder location they are found on your server.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
