    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath, false, Encoding.UTF8))
            {
                ...
                sw.WriteLine("This was drafted for version 20.5.0");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Clean_Bin_Extended1\" />");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Clean_Bin_Extended2\" />");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Discord_Bot_Extended\" />");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Player_Stats_Extended\" />");
                sw.WriteLine();
                sw.WriteLine("Set a numeric value for Height");
                sw.WriteLine("Set True or False for Kick");
                sw.WriteLine("Set True or False for Ban");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Shutdown_Extended\" />");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Vehicle_Recall_Extended\" />");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine("Type /commands in chat to get a list of available chat commands. This will show only commands that are active for the player.");
                sw.WriteLine();
                sw.Flush();
                sw.Close();
            }
