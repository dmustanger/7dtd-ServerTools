            ...
            try
            {
                ...
                if (cInfo != null)
                {
                    ...
                    if (player != null)
                    {
                        ...
                        SdtdConsole.Instance.Output(string.Format("[SERVERTOOLS] Deaths for Id '{0}' '{1}' named '{2}' has been set to '{3}'", cInfo.PlatformId.CombinedString, cInfo.CrossplatformId.CombinedString, cInfo.playerName, value));
                        return;
                    }
                }
                else
