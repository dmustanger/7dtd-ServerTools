    ...
    class ChatColorPrefixConsole : ConsoleCmdAbstract
    {
        ...
        public override string GetHelp()
        {
            return "Usage:\n" +
                ...
                "  4. st-ccp add <steamId/entityId/playerName> <daysToExpire>\n" +
                "  5. st-ccp edit <steamId/entityId/playerName> <nameColor> <prefix> <prefixColor>\n" +
                "  6. st-ccp edit <steamId/entityId/playerName> <daysToExpire>\n" +
                "  7. st-ccp remove <steamId/entityId/playerName>\n" +
                "  8. st-ccp list\n" +
                ...
                else if (_params[0].ToLower().Equals("add"))
                {
                    ...
                    if (_params.Count == 3)
                    {
                        ...
                        if (ChatColor.ExpireDate.ContainsKey(steamId))
                        {
                            ...
                            SdtdConsole.Instance.Output(string.Format("[SERVERTOOLS] Added player id '{0}' with name '{1}' using no colors or prefix. Expiration set to '{2}'", steamId, playerName, expiryDate.ToString()));
                            ChatColor.UpdateXml();
                        }
                        else
                        {
