    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath))
            {
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Flying\" Enable=\"False\" />");
                sw.WriteLine();
                ...
                sw.WriteLine("Detected players are adding to the detection log.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Market\" Enable=\"False\" Return=\"False\" Delay_Between_Uses=\"5\" Market_Size=\"25\" Market_Position=\"- 14,106,-2\" Donor_Only=\"False\" Command_Cost=\"0\" PvP_Check=\"False\" Zombie_Check=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Return");
                sw.WriteLine("Set a numeric value for Delay_Between_Uses");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Set_Home_Extended\" PvP_Check=\"False\" Zombie_Check=\"False\" Vehicle=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for PvP_Check");
                sw.WriteLine("Set True or False for Zombie_Check");
                sw.WriteLine("Set True or False for Vehicle");
                sw.WriteLine();
                sw.WriteLine("Checks for near by players that are not friends and within a certain range before allowing teleport.");
                sw.WriteLine("Checks for near by zombies that are targeting the player and within a certain range before allowing teleport.");
                sw.WriteLine("Checks if the player in a vehicle and will not allow teleport if they are.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Underwater\" Enable=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine();
