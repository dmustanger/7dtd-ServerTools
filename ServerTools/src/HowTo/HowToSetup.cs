    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath))
            {
                ...
                sw.WriteLine();
                sw.WriteLine("Adminstrators that wish to use MySQL must install it and setup their database!!!");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Auction\" Enable =\"False\" Delay_Between_Uses =\"24\" No_Admins =\"False\" Admin_Level =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Delay_Between_Uses");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Auto_Backup\" Enable =\"False\" Time_Between_Saves =\"60\" Destination =\"False\" Days_Before_Save_Delete =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Bank\" Enable =\"False\" Inside_Claim=\"false\" Default_Coin=\"casinoCoin\" Limit=\"50000\" Deposit_Fee=\"5\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Inside_Claim");
                sw.WriteLine("Set your game coin name such as casinoCoin for Default_Coin");
                sw.WriteLine("Set a numeric value for Limit");
                sw.WriteLine("Set a numeric value for Deposit_Fee");
                sw.WriteLine();
                sw.WriteLine("Inside_Claim controls whether players must be inside their own claim to use the bank commands");
                sw.WriteLine("Set your in game coin name found in your default Items.xml for Default_Coin. This is not your wallet coin name.");
                sw.WriteLine("The Limit is the maximum amount that can be stored in a players bank");
                sw.WriteLine("Deposit_Fee controls how much is withdrawn from a deposit to use the bank");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Bloodmoon\" Enable =\"False\" Show_On_Spawn =\"False\" Show_On_Respawn =\"False\" Auto_Show_Bloodmoon_Delay =\"30\" Days_Until_Horde =\"7\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Days_Until_Horde helps detect how many days remain until the next bloodmoon. Set it to your bloodmoon rate, default 7 days.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Chat_Flood_Protection\" Enable =\"False\" Max_Length =\"250\" Messages_Per_Min =\"6\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Credentials\" Enable=\"False\" No_Family_Share=\"False\" Bad_Id=\"False\" No_Internal=\"False\" Admin_Level=\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("All custom commands run a permission check on the player using it. Add commands to your serveradmin.xml at 1000 for normal players.");
                ...
                sw.WriteLine("Add as many console commands as you want to the response but separate them with the symbol ^ .");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine("If your server uses a bloodmoon schedule that is not every 7 days, put the custom value under days until horde.");
                sw.WriteLine("The new optional bloodmoon range system will interfere with this tool and show the incorrect days until bloodmoon some days.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Entity_Cleanup\" Falling_Blocks=\"False\" Falling_Tree=\"False\" Entity_Underground=\"False\" Delete_MiniBikes=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Zombie_Check controls whether the player can be close to a zombie before using this command.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"God_And_Flight_Detector\" Enable=\"False\" Admin_Level=\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Admin_Level");
                sw.WriteLine();
                sw.WriteLine("Starts an automatic check for players using god mode or flying.");
                sw.WriteLine("Set the admin level required to use god mode.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Hardcore\" Enable=\"False\" Max_Deaths=\"20\" Buy_Lives=\"False\" Life_Price=\"2000\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Invalid_Item_Kicker\" Enable=\"False\" Ban=\"False\" Admin_Level=\"0\" Dev_Items=\"False\" Hidden_Items=\"False\" Chest_Checker=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Ban");
                sw.WriteLine("Set a numeric value for Admin_Level");
                sw.WriteLine("Set True or False for Dev_Items");
                sw.WriteLine("Set True or False for Hidden_Items");
                ...
                sw.WriteLine("Dev_Items will detect items marked as Dev for creativemode in the default items.xml.");
                sw.WriteLine("Hidden_Items will detect items marked as None for creativemode in the default items.xml.");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Night_Vote\" Enable=\"False\" Players_Online=\"False\" Votes_Needed=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Players_Online");
                sw.WriteLine("Set True or False for Votes_Needed");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Player_Logs\" Enable=\"False\" Interval=\"60\" Position=\"False\" Inventory=\"False\" Extra=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Position controls whether the current players position, is logged.");
                sw.WriteLine("Inventory controls whether the current players inventory, is logged.");
                sw.WriteLine("Extra controls whether logging health, stamina, zombie kills, player kills and when dead.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Set_Home\" Enable=\"False\" Set_Home2_Enabled=\"False\" Set_Home2_Reserved_Only=\"False\" Delay_Between_Uses=\"60\" Command_Cost =\"0\" PvP_Check=\"False\" Zombie_Check=\"False\" Vehicle=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Vehicle_Teleport\" Enable =\"False\" Delay_Between_Uses =\"False\" Command_Cost =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Delay_Between_Uses");
                sw.WriteLine("Set a numeric values for Command_Cost");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("< Tool Name =\"Wallet\" Coin_Name=\"Coins\" Zombie_Kill_Value=\"10\" Player_Kill_Value=\"50\" Death_Penalty_Value=\"-25\" Lose_On_Death=\"False\" />");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Waypoints\" Enable=\"False\" Max_Waypoints=\"2\" Donator_Max_Waypoints=\"4\" Command_Cost=\"0\" PvP_Check=\"False\" Zombie_Check=\"False\" Vehicle=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Zones\" Enable=\"False\" Kill_Enabled=\"False\" Jail_Enabled=\"False\" Kick_Enabled=\"False\" Ban_Enabled=\"False\" Zone_Message=\"False\" Reminder_Notice_Delay=\"20\"  />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
