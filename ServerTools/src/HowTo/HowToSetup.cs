    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath))
            {
                ...
                sw.WriteLine("All custom commands run a permission check on the player using it. Add commands to your serveradmin.xml at 9999 for normal players.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine();
                sw.WriteLine("Enables private messages between players through chat. Default command is /whisper <playerId/Name> message");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
