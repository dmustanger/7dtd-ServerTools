    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath))
            {
                ...
                sw.WriteLine("Delay controls the time they must wait before being able to use the command again.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Entity_Cleanup\" Enable=\"False\" Max_World=\"50\" Max_Pile=\"11\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Max_World");
                sw.WriteLine("Set a numeric value for Max_Pile");
                sw.WriteLine();
                sw.WriteLine("After the world volume of entities goes over Max_World, an automatic check will run to see if any entites are in a pile.");
                sw.WriteLine("Max_Pile controls the max pile volume before the entities are removed.");
                sw.WriteLine("Players dropping items will no longer be an issue potentially causing lag but find setting that work best for you.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Real_World_Time\" Enable=\"False\" Delay=\"60\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine();
                sw.WriteLine("Enabling will show the real world time periodically based on the delay.");
                sw.WriteLine("Recommend changing the phrase response to match the time zone of the server.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("< Tool Name =\"Shop\" Enable=\"False\" Negative_Wallet=\"False\" Coin_Name=\"Coins\" Zombie_Kill_Value=\"10\" Player_Kill_Value=\"50\" Death_Penalty_Value=\"-25\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
