    ...
    class HowToSetup
    {
        ...
        public static void HowTo()
        {
            using (StreamWriter sw = new StreamWriter(filePath))
            {
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Entity_Underground_Check\" Enable=\"False\" Alert_Admin=\"False\" Admin_Level=\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Alert_Admin");
                sw.WriteLine("Set a numeric value for Admin_Level");
                sw.WriteLine();
                ...
                sw.WriteLine("If an entity is detected underground and can not be sent to the surface while Alert_Admin is set to true, a message will be sent to online admins that match the required level. The message has the coords of the entity.");
                sw.WriteLine("Setting Alert_Admin to 4 would send the alert to all admins or mods listed as tier 0-4.");
                sw.WriteLine("Detections are logged out to the servers default output_log file.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Family_Share_Account\" Enable=\"False\" Admin_Level=\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Admin_Level");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Friend_Teleport\" Enable=\"{0}\" Delay_Between_Uses=\"{1}\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Delay_Between_Uses");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Jail_Commands\" Enable=\"False\" Jail_Size=\"4\" Jail_Position=\" - 14, 106, -2\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Killme\" Enable=\"False\" Delay_Between_Killme=\"60\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Delay_Between_Killme");
                sw.WriteLine();
                sw.WriteLine("Enables the chat command /killme so players can kill themselves.");
                sw.WriteLine("Set the Delay_Between_Killme to control how long a player must wait before /killme will work for them again.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"New_Spawn_Tele\" Enable=\"False\" New_Spawn_Tele_Position=\" - 1, 99, -18\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Reserved_Slots\" Enable=\"False\" Reserved_Check=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("< Tool Name =\"Shop\" Enable=\"False\" Negative_Wallet=\"False\" Coin_Name=\"Coins\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Negative_Wallet");
                sw.WriteLine("Set a value of your choice for Coin_Name");
                sw.WriteLine();
                sw.WriteLine("While enabled, players can use chat command /shop while inside a trader zone.");
                sw.WriteLine("Negative_Wallet controls whether the player can go into a negative in their wallet.");
                sw.WriteLine("Coin_Name is what you would like the currency in your shops to be called.");
                ...
                sw.WriteLine("The wallet is calculated as follows: PvE = zombie kills(+10) + deaths(-50) + spent coins.");
                sw.WriteLine("The wallet is calculated as follows: PvP = zombie kills(+10) + player kills(+25) + deaths(-50) + spent coins.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Stopserver\" Ten_Second_Countdown_Enabled=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Ten_Second_Countdown_Enabled");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Teleport_Check\" Enable=\"False\" Admin_Level=\"0\" Kill_Enabled=\"False\" Announce=\"False\" Jail_Enabled=\"False\" Kick_Enabled=\"False\" Ban_Enabled=\"False\" Days_Before_Log_Delete=\"5\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Admin_Level");
                sw.WriteLine("Set True or False for Kill_Enabled");
                sw.WriteLine("Set True or False for Announce");
                sw.WriteLine("Set True or False for Jail_Enabled");
                sw.WriteLine("Set True or False for Kick_Enabled");
                sw.WriteLine("Set True or False for Ban_Enabled");
                sw.WriteLine("Set a numeric value  for Days_Before_Log_Delete");
                sw.WriteLine();
                sw.WriteLine("Automatically detects players that abuse teleporting through cheats.");
                sw.WriteLine("Has fail safe checks against ServerTools commands that may cause false positives..");
                sw.WriteLine("Those caught are logged.");
                sw.WriteLine("Log files will auto delete themselves after a set amount of days. Days_Before_Log_Delete controls the amount of days.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
