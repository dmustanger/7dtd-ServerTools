    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath))
            {
                ...
                sw.WriteLine("This was drafted for version 10.5");
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Bike\" Enable =\"False\" Delay_Between_Uses =\"False\" Command_Cost =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Delay_Between_Uses");
                sw.WriteLine("Set a numeric values for Command_Cost");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Bounties\" Enable =\"False\" Bounty =\"5\" Kill_Streak =\"5\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Lobby\" Enable=\"False\" Return=\"False\" Delay_Between_Uses=\"5\" Lobby_Size=\"25\" Lobby_Position=\"- 14, 106, -2\" Command_Cost =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Travel\" Enable=\"False\" Delay_Between_Uses=\"0\" Command_Cost =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Delay_Between_Uses");
                sw.WriteLine("Set a numeric values for Command_Cost");
