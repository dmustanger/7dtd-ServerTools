    ...
    class HowToSetup
    {
        ...
        public static void Load()
        {
            using (StreamWriter sw = new StreamWriter(filePath))
            {
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Auction\" Enable =\"False\" Delay_Between_Uses =\"30\" Cancel_Time =\"15\" No_Admins =\"False\" Admin_Level =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Delay_Between_Uses");
                sw.WriteLine("Set a numeric value for Cancel_Time");
                ...
                sw.WriteLine("Delay_Between_Uses controls how long a player must wait to sell a new item after selling one through the auction. Delay is in minutes.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Auto_Backup\" Enable =\"False\" Time_Between_Saves =\"60\" Destination =\"False\" Compression_Level =\"False\" Days_Before_Save_Delete =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Days_Before_Save_Delete controls how old a backup can be before it is removed.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Auto_Shutdown\" Enable =\"False\" Countdown_Timer =\"5\" Time_Before_Shutdown =\"60\" Alert_On_Login=\"False\" Kick_During_Countdown=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Battle_Loggers\" Enable=\"False\" All=\"False\" Belt=\"False\" Bag=\"False\" Equipment=\"False\" Admin_Level=\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Set True or False for Admin_Level");
                sw.WriteLine();
                sw.WriteLine("While enabled, players must type /exit or /quit to exit the game safely.");
                sw.WriteLine("If a player tries to leave the game without typing /exit and are hostile with a nearby player, they will drop items.");
                sw.WriteLine("Players become hostile by doing damage to each other. They must be within 100 blocks.");
                sw.WriteLine("Set whatever items you want to drop, all, belt, bag or equipment.");
                sw.WriteLine("Admin are not effected by this tool.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Bloodmoon_Warrior\" Enable =\"False\" Zombie_Kills=\"10\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Players death count will reduce by one if successful and they will receive one item from the list.");
                sw.WriteLine("Players can not log out or disconnect during the event. There is no penalty for failure.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Flying\" Enable=\"False\" Admin_Level=\"0\" Flags=\"4\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Flying");
                sw.WriteLine("Set a numeric value for Admin_Level");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Invalid_Item_Kicker\" Enable=\"False\" Ban=\"False\" Admin_Level=\"0\" Chest_Checker=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set True or False for Ban");
                sw.WriteLine("Set a numeric value for Admin_Level");
                sw.WriteLine("Set True or False for Chest_Checker");
                sw.WriteLine();
                ...
                sw.WriteLine("Chest_Checker will check inside secure chests for invalid items and remove them every 5 minutes.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Lobby\" Enable=\"False\" Return=\"False\" Delay_Between_Uses=\"5\" Lobby_Size=\"25\" Lobby_Position=\"- 14,106,-2\" Donor_Only=\"False\" Command_Cost=\"0\" PvP_Check=\"False\" Zombie_Check=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Lobby_Extended\" Player_Check=\"False\" Zombie_Check=\"False\" PvE=\"False\" />");
                sw.WriteLine();
                ...
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine();
                sw.WriteLine("Enables private messages between players through chat");
                sw.WriteLine("Default command is /pm \"<playerId/Name>\" \"message\"");
                sw.WriteLine("Players can respond to the last person who sent a private chat by typing /rm \"message\" or by /pm \"<playerId/Name>\" \"message\"");
                sw.WriteLine("Alternatively players can use pmessage and rmessage instead of pm and rm");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine("Example: /pm 171 Hey buddy, lets buddy up.");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Set_Home\" Enable=\"False\" Set_Home2_Enabled=\"False\" Set_Home2_Reserved_Only=\"False\" Home2_Delay=\"False\" Delay_Between_Uses=\"60\" Command_Cost =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Tracking\" Enable=\"False\" Rate=\"60\" Days_Before_Log_Delete=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine("Set a numeric value for Rate");
                sw.WriteLine("Set True or False for Days_Before_Log_Delete");
                sw.WriteLine();
                sw.WriteLine("Enables the tracking logger to create a database log of player positions.");
                sw.WriteLine("Set the Rate at which the log will track each player. Rate is in seconds.");
                sw.WriteLine("Set Days_Before_Log_Delete to control how long a track record is stored in the database.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Under_Water\" Enable=\"False\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                sw.WriteLine();
                sw.WriteLine("Monitors if a player is submerged under water and teleports them to the surface if underwater too long. This is to help prevent underwater bases.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Vehicle_Teleport_Extended\" Inside_Claim =\"False\" Delay_Between_Uses =\"0\" Command_Cost =\"0\" />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Inside_Claim");
                sw.WriteLine("Set a numeric value for Delay_Between_Uses");
                sw.WriteLine("Set a numeric values for Command_Cost");
                ...
                sw.WriteLine("Check available website console commands by running 'help website' in the console.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                ...
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Zones\" Enable=\"False\" Kill_Enabled=\"False\" Jail_Enabled=\"False\" Kick_Enabled=\"False\" Ban_Enabled=\"False\" Zone_Message=\"False\"  />");
                sw.WriteLine();
                sw.WriteLine("Set True or False for Enable");
                ...
                sw.WriteLine("Set the zone as PvE inside the xml. PvE will allow punishing players for killing inside the zone.");
                sw.WriteLine("Remove zombies from zones by setting No_Zombie to true in the xml file.");
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine();
                sw.WriteLine("<Tool Name=\"Zones_Extended\" Reminder_Notice_Delay=\"20\" Set_Home=\"False\"  />");
                sw.WriteLine();
                sw.WriteLine("Set a numeric value for Reminder_Notice_Delay");
                sw.WriteLine("Set True or False for Set_Home");
                sw.WriteLine();
                sw.WriteLine("Reminder_Notice_Delay controls how often players are reminded of being inside the zone.");
