            ...
            if (!VoteOpen)
            {
                ...
                if (_timepassed >= 60)
                {
                    ...
                    if (_playerCount >= Players_Online)
                    {
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase871 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase875 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                    else
                    {
                        Phrases.Dict.TryGetValue(876, out string _phrase876);
                        ChatHook.ChatMessage(_cInfo, LoadConfig.Chat_Response_Color + _phrase876 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Whisper, null);
                    }
                }
                else
                {
                    ...
                    ChatHook.ChatMessage(_cInfo, LoadConfig.Chat_Response_Color + _phrase877 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Whisper, null);
                }
            }
            else
            {
        ...
        public static void ProcessWeatherVote()
        {
            if (Sun.Count + Rain.Count + Snow.Count >= Votes_Needed)
            {
                if (Sun.Count > Rain.Count && Sun.Count > Snow.Count)
                {
                    ...
                    ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase879 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                }
                else if (Rain.Count > Sun.Count && Rain.Count > Snow.Count)
                {
                    ...
                    if (_rndWeather == 1)
                    {
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase880 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                    if (_rndWeather == 2)
                    {
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase881 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                    if (_rndWeather == 3)
                    {
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase882 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                }
                else if (Snow.Count > Sun.Count && Snow.Count > Rain.Count)
                {
                    ...
                    if (_rndWeather == 1)
                    {
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase883 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                    if (_rndWeather == 2)
                    {
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase884 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                    if (_rndWeather == 3)
                    {
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase885 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                }
                else if (Sun.Count == 0 && Rain.Count == 0 && Snow.Count == 0)
                {
                    Phrases.Dict.TryGetValue(872, out string _phrase872);
                    ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase872 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                }
                else
                {
                    if (_weather != "")
                    {
                        ...
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase873 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                    else if (Sun.Count > 0 && Rain.Count > 0 && Snow.Count > 0)
                    {
                        Phrases.Dict.TryGetValue(874, out string _phrase874);
                        ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase874 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                    }
                }
            }
            else
            {
                ...
                ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase886 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
            }
