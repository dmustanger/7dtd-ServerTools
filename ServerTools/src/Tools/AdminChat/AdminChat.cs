...
namespace ServerTools
{
    public class AdminChat
    {
        ...
        {
            if (GameManager.Instance.adminTools.CommandAllowedFor(new string[] { _message }, _sender) || GameManager.Instance.adminTools.GetUserPermissionLevel(_sender) <= ChatHook.Mod_Level)
            {
