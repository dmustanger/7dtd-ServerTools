...
namespace ServerTools
{
    class Event
    {
        ...
        public static void CheckOpen()
        {
            if (!Open)
            {
                ...
                if (_cInfo != null)
                {
                    ...
                    ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase771 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
                }
                Phrases.Dict.TryGetValue(772, out string _phrase772);
                ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase772 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
            }
        }
        ...
        public static void HalfTime()
        {
            ...
            ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase780 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
        }
        ...
        public static void FiveMin()
        {
            ...
            ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase781 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
        }
        ...
        public static void EndEvent()
        {
            ...
            ChatHook.ChatMessage(null, LoadConfig.Chat_Response_Color + _phrase783 + "[-]", -1, LoadConfig.Server_Response_Name, EChatType.Global, null);
        }
