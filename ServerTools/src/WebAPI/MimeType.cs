...
namespace ServerTools.WebAPI
{
	...
	{
		// Token: 0x0600003F RID: 63 RVA: 0x000044B8 File Offset: 0x000026B8
		public static string GetMimeType(string _extension)
		{
			...
			return (!MimeType._mappings.TryGetValue(_extension, out string text)) ? "application/octet-stream" : text;
		}

		// Token: 0x04000029 RID: 41
		private static readonly IDictionary<string, string> _mappings = new CaseInsensitiveStringDictionary<string>
		{
			{
				".323",
				"text/h323"
