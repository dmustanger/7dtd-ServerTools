...
namespace ServerTools
{
    public class HighPingKicker
    {
        ...
        private static void KickPlayer(ClientInfo _cInfo)
        {
            ...
            GameManager.Instance.GameMessageServer((ClientInfo)null, EnumGameMessages.Chat, string.Format("[FF8000]{0}[-]", _phrase1), Config.Server_Response_Name, false, "ServerTools", false);
