                    ...
                    foreach (XmlNode subChild in childNode.ChildNodes)
                    {
                        ...
                        switch (_line.GetAttribute("Name"))
                        {
                            ...
                            case "Bloodmoon_Warrior":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Bloodmoon_Warrior entry because of missing 'Reward_Count' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Reward_Count"), out BloodmoonWarrior.Reward_Count))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Bloodmoon_Warrior entry because of invalid (non-numeric) value for 'Reward_Count' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                break;
                            case "Bounties":
                            ...
                            case "Chat_Command_Response":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Chat_Command_Response entry because of missing 'Chat_Command_Prefix1' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Chat_Command_Prefix2"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Chat_Command_Response entry because of missing 'Chat_Command_Prefix2' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (_line.HasAttribute("Server_Response_Name"))
                                {
                            ...
                            case "Exit_Command":
                                if (!_line.HasAttribute("Enable"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of missing 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Enable"), out ExitCommand.IsEnabled))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of invalid (True/False) value for 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("All"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of missing 'All' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("All"), out ExitCommand.All))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of invalid (True/False) value for 'All' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Belt"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of missing 'Belt' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Belt"), out ExitCommand.Belt))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of invalid (True/False) value for 'Belt' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Bag"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of missing 'Bag' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Bag"), out ExitCommand.Bag))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of invalid (True/False) value for 'Bag' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Equipment"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of missing 'Equipment' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Equipment"), out ExitCommand.Equipment))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command entry because of invalid (True/False) value for 'Equipment' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                break;
                            case "Exit_Command_Extended":
                                if (!_line.HasAttribute("Admin_Level"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command_Extended entry because of missing 'Admin_Level' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Admin_Level"), out ExitCommand.Admin_Level))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command_Extended entry because of invalid (non-numeric) value for 'Admin_Level' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Exit_Time"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command_Extended entry because of missing 'Exit_Time' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Exit_Time"), out ExitCommand.Exit_Time))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Exit_Command_Extended entry because of invalid (non-numeric) value for 'Exit_Time' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                break;
                            ...
                            case "Friend_Teleport":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Friend_Teleport entry because of missing 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Player_Check"), out FriendTeleport.Player_Check))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Friend_Teleport entry because of invalid (True/False) value for 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                            ...
                            case "Homes":
                                if (!_line.HasAttribute("Enable"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of missing 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Enable"), out Homes.IsEnabled))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of invalid (True/False) value for 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Max_Homes"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of missing 'Max_Homes' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Max_Homes"), out Homes.Max_Homes))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of invalid (non-numeric) value for 'Max_Homes' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Reserved_Max_Homes"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of missing 'Reserved_Max_Homes' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Reserved_Max_Homes"), out Homes.Reserved_Max_Homes))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of invalid (non-numeric) value for 'Reserved_Max_Homes' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Command_Cost"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of missing 'Command_Cost' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Command_Cost"), out Homes.Command_Cost))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of invalid (non-numeric) value for 'Command_Cost' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Delay_Between_Uses"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of missing 'Delay_Between_Uses' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Delay_Between_Uses"), out Homes.Delay_Between_Uses))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes entry because of invalid (non-numeric) value for 'Delay_Between_Uses' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                break;
                            case "Homes_Extended":
                                if (!_line.HasAttribute("Player_Check"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes_Extended entry because of missing 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Player_Check"), out Homes.Player_Check))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes_Extended entry because of invalid (non-numeric) value for 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Zombie_Check"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes_Extended entry because of missing 'Zombie_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Zombie_Check"), out Homes.Zombie_Check))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes_Extended entry because of invalid (non-numeric) value for 'Zombie_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Vehicle"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes_Extended entry because of missing 'Vehicle' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Vehicle"), out Homes.Vehicle_Check))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Homes_Extended entry because of invalid (non-numeric) value for 'Vehicle' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                break;
                            case "Hordes":
                            ...
                            case "Lobby_Extended":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Lobby entry because of missing 'Reserved_Only' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Reserved_Only"), out Lobby.Reserved_Only))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Lobby entry because of invalid (True/False) value for 'Reserved_Only' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Command_Cost"))
                                {
                            ...
                            case "Market_Extended":
                                if (!_line.HasAttribute("Reserved_Only"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Market entry because of missing 'Reserved_Only' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Reserved_Only"), out Market.Reserved_Only))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Market entry because of invalid (True/False) value for 'Reserved_Only' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Command_Cost"))
                                {
                            ...
                            case "New_Player_Extended":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring New_Player_Extended entry because of missing 'Block_During_Bloodmoon' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Block_During_Bloodmoon"), out NewPlayer.Block_During_Bloodmoon))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring New_Player_Extended entry because of invalid (True/False) value for 'Block_During_Bloodmoon' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                break;
                            case "New_Spawn_Tele":
                            ...
                            case "Player_Stats_Extended":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Player_Stats_Extended entry because of missing 'Height' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!double.TryParse(_line.GetAttribute("Height"), out PlayerStats.Height))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Player_Stats_Extended entry because of invalid (non-numeric) value for 'Height' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Admin_Level"))
                                {
                            ...
                            case "POI_Protection":
                                if (!_line.HasAttribute("Enable"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring POI_Protection entry because of missing 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Enable"), out POIProtection.IsEnabled))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring POI_Protection entry because of invalid (True/False) value for 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Bed"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring POI_Protection entry because of missing 'Bed' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Bed"), out POIProtection.Bed))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring POI_Protection entry because of invalid (True/False) value for 'Bed' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Claim"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring POI_Protection entry because of missing 'Claim' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Claim"), out POIProtection.Claim))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring POI_Protection entry because of invalid (True/False) value for 'Claim' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                break;
                            case "Poll":
                            ...
                            case "Sleeper_Respawn":
                                if (!_line.HasAttribute("Enable"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Sleeper_Respawn entry because of missing 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Enable"), out SleeperRespawn.IsEnabled))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Sleeper_Respawn entry because of invalid (True/False) value for 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                break;
                            ...
                            case "Suicide":
                                ...
                                if (!_line.HasAttribute("Player_Check"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Killme entry because of missing 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Player_Check"), out Suicide.Player_Check))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Killme entry because of invalid (True/False) value for 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Zombie_Check"))
                                {
                            ...
                            case "Travel":
                                ...
                                if (!_line.HasAttribute("Player_Check"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Travel entry because of missing 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Player_Check"), out Travel.Player_Check))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Travel entry because of invalid (True/False) value for 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Zombie_Check"))
                                {
                            ...
                            case "Vehicle_Teleport_Extended":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Vehicle_Teleport_Extended entry because of missing 'Gyro' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Gyro"), out VehicleTeleport.Gyro))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Vehicle_Teleport_Extended entry because of invalid (True/False) value for 'Gyro' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Inside_Claim"))
                                {
                            ...
                            case "Voting_Extended":
                                if (!_line.HasAttribute("Reward_Count"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Voting_Extended entry because of missing 'Reward_Count' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Reward_Count"), out VoteReward.Reward_Count))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Voting_Extended entry because of invalid (non-numeric) value for 'Reward_Count' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                            ...
                            case "Wallet_Extended":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Wallet_Extended entry because of missing 'Death_Penalty_Value' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Death_Penalty_Value"), out Wallet.Deaths))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Wallet_Extended entry because of invalid (non-numeric) value for 'Death_Penalty_Value' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                            ...
                            case "Waypoints":
                                ...
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Waypoints entry because of missing 'Reserved_Max_Waypoints' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!int.TryParse(_line.GetAttribute("Reserved_Max_Waypoints"), out Waypoints.Reserved_Max_Waypoints))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Waypoints entry because of invalid (non-numeric) value for 'Reserved_Max_Waypoints' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Command_Cost"))
                                {
                            ...
                            case "Waypoints_Extended":
                                if (!_line.HasAttribute("Player_Check"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Waypoints_Extended entry because of missing 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!bool.TryParse(_line.GetAttribute("Player_Check"), out Waypoints.Player_Check))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Waypoints_Extended entry because of invalid (non-numeric) value for 'Player_Check' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
                                if (!_line.HasAttribute("Zombie_Check"))
                                {
                            ...
                            case "Web_Panel":
                                if (!_line.HasAttribute("Enable"))
                                {
                                    Log.Warning(string.Format("[SERVERTOOLS] Ignoring Web_Panel entry because of missing 'Enable' attribute: {0}", subChild.OuterXml));
                                    continue;
                                }
