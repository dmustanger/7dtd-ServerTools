    ...
    public class Config
    {
                        ...
                        if (line.HasAttributes && line.HasAttribute("Name"))
                        {
                            switch (line.GetAttribute("Name"))
                            {
                                ...
                                case "Net_Package_Detector":
                                    ...
                                    if (!bool.TryParse(line.GetAttribute("Enable"), out GeneralOperations.Net_Package_Detector))
                                    {
                                ...
                                case "Normal_Player_Color_Prefix":
                                    ...
                                    break;
                                case "Output_Log":
                                    if (!line.HasAttribute("Vehicle_Manager_Off"))
                                    {
                                        Log.Warning(string.Format("[SERVERTOOLS] Ignoring Output_Log entry in ServerToolsConfig.xml because of missing 'Vehicle_Manager_Off' attribute: {0}", line.OuterXml));
                                        continue;
                                    }
                                    if (!bool.TryParse(line.GetAttribute("Vehicle_Manager_Off"), out OutputLog.Vehicle_Manager_Off))
                                    {
                                        Log.Warning(string.Format("[SERVERTOOLS] Ignoring Output_Log entry in ServerToolsConfig.xml because of invalid (True/False) value for 'Vehicle_Manager_Off' attribute: {0}", line.OuterXml));
                                        continue;
                                    }
                                    break;
        ...
        public static void WriteXml()
        {
            ...
            using (StreamWriter sw = new StreamWriter(ConfigFilePath, false, Encoding.UTF8))
            {
                ...
                sw.WriteLine("        <Tool Name=\"Damage_Detector\" Enable=\"{0}\" Entity_Damage_Limit=\"{1}\" Block_Damage_Limit=\"{2}\" Player_Damage_Limit=\"{3}\" Admin_Level=\"{4}\" />", DamageDetector.IsEnabled, DamageDetector.Entity_Damage_Limit, DamageDetector.Block_Damage_Limit, DamageDetector.Player_Damage_Limit, DamageDetector.Admin_Level);
                ...
                //sw.WriteLine("        <Tool Name=\"Magic_Bullet_Detector\" Enable=\"{0}\" />", MagicBullet.IsEnabled);
                sw.WriteLine("        <Tool Name=\"Net_Package_Detector\" Enable=\"{0}\" />", GeneralOperations.Net_Package_Detector);
                sw.WriteLine("        <Tool Name=\"Player_Logs\" Enable=\"{0}\" Vehicle=\"{1}\" Interval=\"{2}\" />", PlayerLogs.IsEnabled, PlayerLogs.Vehicle, PlayerLogs.Delay);
                sw.WriteLine("        <Tool Name=\"Player_Stats\" Enable=\"{0}\" Health=\"{1}\" Stamina=\"{2}\" Jump_Strength=\"{3}\" />", PlayerStats.IsEnabled, PlayerStats.Health, PlayerStats.Stamina, PlayerStats.Jump_Strength);
                sw.WriteLine("        <Tool Name=\"Player_Stats_Extended\" Height=\"{0}\" Admin_Level=\"{1}\" Kick_Enabled=\"{2}\" Ban_Enabled=\"{3}\" />", PlayerStats.Height, PlayerStats.Admin_Level, PlayerStats.Kick_Enabled, PlayerStats.Ban_Enabled);
                sw.WriteLine("        <Tool Name=\"Protected_Zones\" Enable=\"{0}\" />", ProtectedZones.IsEnabled);
                sw.WriteLine("        <Tool Name=\"PvE_Violations\" Jail=\"{0}\" Kill=\"{1}\" Kick=\"{2}\" Ban=\"{3}\" />", GeneralOperations.Jail_Violation, GeneralOperations.Kill_Violation, GeneralOperations.Kick_Violation, GeneralOperations.Ban_Violation);
                sw.WriteLine("        <Tool Name=\"Spectator_Detector\" Enable=\"{0}\" Admin_Level=\"{1}\" />", PlayerChecks.SpectatorEnabled, PlayerChecks.Spectator_Admin_Level);
                sw.WriteLine("        <Tool Name=\"Speed_Detector\" Enable=\"{0}\" Admin_Level=\"{1}\" Flags=\"{2}\" />", SpeedDetector.IsEnabled, SpeedDetector.Speed_Admin_Level, SpeedDetector.Total_Flags);
                sw.WriteLine("        <Tool Name=\"Teleport_Detector\" Enable=\"{0}\" Jail=\"{1}\" Kill=\"{2}\" Kick=\"{3}\" Ban=\"{4}\" />", TeleportDetector.IsEnabled, TeleportDetector.Jail, TeleportDetector.Kill, TeleportDetector.Kick, TeleportDetector.Ban);
                sw.WriteLine("        <Tool Name=\"XRay_Detector\" Enable=\"{0}\" Admin_Level=\"{1}\" />", XRayDetector.IsEnabled, XRayDetector.Admin_Level);
                sw.WriteLine("    </AntiCheat>");
                sw.WriteLine("    <Tools>");
                ...
                sw.WriteLine("        <Tool Name=\"FPS\" Enable=\"{0}\" />", Fps.IsEnabled);
                ...
                sw.WriteLine("        <Tool Name=\"Hordes\" Enable=\"{0}\" Players=\"{1}\" Zombies=\"{2}\" />", Hordes.IsEnabled, Hordes.Players, Hordes.Zombies);
                ...
                sw.WriteLine("        <Tool Name=\"Lobby_Extended1\" Reserved_Only=\"{0}\" Command_Cost=\"{1}\" PvE=\"{2}\" Damage_Z=\"{3}\" />", Lobby.Reserved_Only, Lobby.Command_Cost, Lobby.PvE, Lobby.Damage_Z);
                ...
                sw.WriteLine("        <Tool Name=\"Market_Extended1\" Reserved_Only=\"{0}\" Command_Cost=\"{1}\" PvE=\"{2}\" Damage_Z=\"{3}\" />", Market.Reserved_Only, Market.Command_Cost, Market.PvE, Market.Damage_Z, Market.Player_Check, Market.Zombie_Check);
                ...
                sw.WriteLine("        <Tool Name=\"Output_Log\" Vehicle_Manager_Off=\"{0}\" />", OutputLog.Vehicle_Manager_Off);
                ...
                sw.WriteLine("        <Tool Name=\"Vehicle_Recall\" Enable=\"{0}\" Inside_Claim=\"{1}\" Distance=\"{2}\" Delay_Between_Uses=\"{3}\" Command_Cost=\"{4}\" />", VehicleRecall.IsEnabled, VehicleRecall.Inside_Claim, VehicleRecall.Distance, VehicleRecall.Delay_Between_Uses, VehicleRecall.Command_Cost);
