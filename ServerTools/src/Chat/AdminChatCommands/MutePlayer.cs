namespace ServerTools
{
    public class MutePlayer
    {
                ...
                else
                {
                    ...
                    else
                    {
                        if (p.IsMuted)
                        {
                            ...
                            _cInfo.SendPackage(new NetPackageGameMessage(EnumGameMessages.Chat, string.Format("{1}{0}[-]", _phrase202, Config.ChatResponseColor), "Server", false, "", false));
                        }
                        else
                        {
                            Mute(_cInfo, _PlayertoMute);
        ...
        public static void Mute (ClientInfo _admin, ClientInfo _player)
        {
            ...
            _admin.SendPackage(new NetPackageGameMessage(EnumGameMessages.Chat, string.Format("{1}{0}[-]", _phrase203, Config.ChatResponseColor), "Server", false, "", false));
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (p == null)
                    {
                        ...
                        _cInfo.SendPackage(new NetPackageGameMessage(EnumGameMessages.Chat, string.Format("{1}{0}[-]", _phrase204, Config.ChatResponseColor), "Server", false, "", false));
                    }
                    else
                    {
                        if (!p.IsMuted)
                        ...
                        else
                        {
                            ...
                            _cInfo.SendPackage(new NetPackageGameMessage(EnumGameMessages.Chat, string.Format("{1}{0}[-]", _phrase205, Config.ChatResponseColor), "Server", false, "", false));
                        }
                    }
                }
            }
