...
namespace ServerTools
{
    public class TeleportHome
    {
        ...
        public static void SetHome(ClientInfo _cInfo)
        {
            ...
            {
                _cInfo.SendPackage(new NetPackageGameMessage(EnumGameMessages.Chat, string.Format("{1}You can not use this while in jail.[-]", Config.ChatColor), "Server", false, "", false));
            }
        }
