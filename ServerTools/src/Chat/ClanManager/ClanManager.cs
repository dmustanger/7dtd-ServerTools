    ...
    public class ClanManager
    {
        ...
        public static void InviteAccept(ClientInfo _cInfo)
        {
            ...
            else
            {
                if (!ClanData.ClansList.Contains(_clanName))
                {
                    string _phrase114 = "{PlayerName} the clan ould not be found.";
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (Phrases._Phrases.TryGetValue(120, out _phrase120))
                                        {
                                            ...
                                            _phrase120 = _phrase120.Replace("{PlayertoRemove}", _PlayertoRemove.playerName);
                                        ...
                                        {
                                            _phrase121 = _phrase121.Replace("{PlayerName}", _PlayertoRemove.playerName);
