...
function Handshake() {
  ...
  _post.open('POST', window.location.href.replace('st.html', 'Post/Handshake'), false);
  ...
  _post.onload = function () {
    if (_post.status === 200 && _post.responseText.length === 4000) {
      ...
      _post2.open('POST', window.location.href.replace('st.html', 'Post/Secure'), false);
      ...
      if (document.getElementById("Text2").value) {
        ...
        if (_text2.length > 5 && _text2.length < 21) {
          if (document.getElementById("NotBotBox1").checked) {
            ...
            let _uri = window.location.href;
            let _post = new XMLHttpRequest();
            _post.open('POST', window.location.href.replace('st.html', 'Post/SignIn'), false);
            _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
            _post.onload = function () {
              if (_post.status === 200 && _post.responseText.length === 4000) {
                let _r = "";
...
function SignOut() {
  if (document.getElementById("ConfirmSignout").checked) {
    ...
    let _uri = window.location.href;
    let _post = new XMLHttpRequest();
    _post.open('POST', window.location.href.replace('st.html', 'Post/SignOut'), false);
    _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
    _post.onload = function () {
      if (_post.status === 200) {
...
function NewPass() {
  ...
  let _uri = window.location.href;
  let _post = new XMLHttpRequest();
  _post.open('POST', window.location.href.replace('st.html', 'Post/NewPass'), false);
  _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
  _post.onload = function () {
    if (_post.status === 200 && _post.responseText.length === 4000) {
      let _r = "";
        ...
        if (_confirm.length > 5 && _confirm.length < 21) {
          if (_password === _confirm) {
            if (document.getElementById("NotBotBox2").checked) {
              ...
              let _uri = window.location.href;
              let _post = new XMLHttpRequest();
              _post.open('POST', window.location.href.replace('st.html', 'Post/SetPass'), false);
              _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
              _post.onload = function () {
                if (_post.status === 200 && _post.responseText.length === 4000) {
                  let _r = "";
...
function Command() {
  if (document.getElementById('ConsoleCommand').value) {
    ...
    let _uri = window.location.href;
    let _post = new XMLHttpRequest();
    _post.open('POST', window.location.href.replace('st.html', 'Post/Command'), false);
    _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
    _post.onload = function () {
      if (_post.status === 200 && _post.responseText.length === 4000) {
...
function ConsolePage() {
  ...
  let _uri = window.location.href;
  let _post = new XMLHttpRequest();
  _post.open('POST', window.location.href.replace('st.html', 'Post/Log'), false);
  _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
  _post.onload = function () {
    document.getElementById('BackgroundContainer').style.visibility = "hidden";
    document.getElementById("ConfigContainer").style.visibility = "hidden";
...
function updatePlayers() {
  ...
  let _uri = window.location.href;
  let _post = new XMLHttpRequest();
  _post.open('POST', window.location.href.replace('st.html', 'Post/Players'), false);
  _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
  _post.onload = function () {
    if (_post.status === 200 && _post.responseText.length === 4000) {
      let _r = "";
      ...
      let _post2 = new XMLHttpRequest();
      _post2.open('POST', window.location.href.replace('st.html', 'Post/Players'), false);
      _post2.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
      _post2.onload = function () {
...
function Config() {
  ...
  let _uri = window.location.href;
  let _post = new XMLHttpRequest();
  _post.open('POST', window.location.href.replace('st.html', 'Post/Config'), false);
  _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
  _post.onload = function () {
    if (_post.status === 200 && _post.responseText.length === 4000) {
      let _r = "";
      ...
      let _post2 = new XMLHttpRequest();
      _post2.open('POST', window.location.href.replace('st.html', 'Post/Config'), false);
      _post2.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
      _post2.onload = function () {
        if (_post2.status === 200) {
          let _resp = _post2.responseText.split('§');
...
function SaveConfig() {
  if (document.getElementById("AcceptSave").checked) {
    ...
    let _uri = window.location.href;
    let _post = new XMLHttpRequest();
    _post.open('POST', window.location.href.replace('st.html', 'Post/UpdateConfig'), false);
    _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
    _post.onload = function () {
      if (_post.status === 200 && _post.responseText.length === 4000) {
        let _r = "";
        ...
        let _post2 = new XMLHttpRequest();
        _post2.open('POST', window.location.href.replace('st.html', 'Post/UpdateConfig'), false);
        _post2.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
        _post2.send(_cPR);
      }
    };
...
function Kick() {
  let _steamId = document.getElementById("PlayersSteamId").value;
    ...
    let _uri = window.location.href;
    let _post = new XMLHttpRequest();
    _post.open('POST', window.location.href.replace('st.html', 'Post/Kick'), false);
    _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
    _post.onload = function () {
      if (_post.status === 200 && _post.responseText.length === 4000) {
        let _r = "";
...
function Ban() {
  let _steamId = document.getElementById("PlayersSteamId").value;
    ...
    let _uri = window.location.href;
    let _post = new XMLHttpRequest();
    _post.open('POST', window.location.href.replace('st.html', 'Post/Ban'), false);
    _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
    _post.onload = function () {
      if (_post.status === 200 && _post.responseText.length === 4000) {
        let _r = "";
...
function Mute() {
  let _steamId = document.getElementById("PlayersSteamId").value;
    ...
    let _uri = window.location.href;
    let _post = new XMLHttpRequest();
    _post.open('POST', window.location.href.replace('st.html', 'Post/Mute'), false);
    _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
    _post.onload = function () {
      if (_post.status === 200 && _post.responseText.length === 4000) {
        let _r = "";
...
function Jail() {
  let _steamId = document.getElementById("PlayersSteamId").value;
    ...
    let _uri = window.location.href;
    let _post = new XMLHttpRequest();
    _post.open('POST', window.location.href.replace('st.html', 'Post/Jail'), false);
    _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
    _post.onload = function () {
      if (_post.status === 200 && _post.responseText.length === 4000) {
        let _r = "";
...
function Reward() {
  let _steamId = document.getElementById("PlayersSteamId").value;
    ...
    let _uri = window.location.href;
    let _post = new XMLHttpRequest();
    _post.open('POST', window.location.href.replace('st.html', 'Post/Reward'), false);
    _post.setRequestHeader('Content-Type', 'text/plain; charset=utf-8');
    _post.onload = function () {
      if (_post.status === 200 && _post.responseText.length === 4000) {
        let _r = "";
